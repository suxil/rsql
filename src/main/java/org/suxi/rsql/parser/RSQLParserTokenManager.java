/* RSQLParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. RSQLParserTokenManager.java */
...
class RSQLParserTokenManager implements RSQLParserConstants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public RSQLParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public RSQLParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
